...
(require 'pymacs (concat starter-kit-dir "elpa-to-submit/pymacs.el"))
...
(defun setup-ropemacs ()
  ...
  (setenv "PYTHONPATH"
          (concat
           ...
           (concat starter-kit-dir "python-libs/")))
...
is passed after the options."
     ...
     (defun flymake-pylint-init ()
       (flymake-command-setup "python" (list (concat starter-kit-dir "scripts/pylint-mod.py"))))
